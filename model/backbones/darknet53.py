...
class Darknet53(nn.Module):
    ...
    def __init__(self):
        ...
        self.__rb_5_1 = Residual_block(filters_in=128, filters_out=128, filters_medium=64)
        self.__rb_5_2 = Residual_block(filters_in=256, filters_out=256, filters_medium=128)
        self.__rb_5_3 = Residual_block(filters_in=512, filters_out=512, filters_medium=256)
        self.__rb_5_4 = Residual_block(filters_in=1024, filters_out=1024, filters_medium=512)
    ...
    def forward(self, x):
        ...
        x1_1 = self.__rb_5_1(x1_0)
        x1_2 = self.__rb_5_1(x1_1)

        x2_0 = self.__conv_5_2(x1_2)
        x2_1 = self.__rb_5_2(x2_0)
        x2_2 = self.__rb_5_2(x2_1)
        x2_3 = self.__rb_5_2(x2_2)
        x2_4 = self.__rb_5_2(x2_3)
        x2_5 = self.__rb_5_2(x2_4)
        x2_6 = self.__rb_5_2(x2_5)
        x2_7 = self.__rb_5_2(x2_6)
        x2_8 = self.__rb_5_2(x2_7)

        x3_0 = self.__conv_5_3(x2_8)
        x3_1 = self.__rb_5_3(x3_0)
        x3_2 = self.__rb_5_3(x3_1)
        x3_3 = self.__rb_5_3(x3_2)
        x3_4 = self.__rb_5_3(x3_3)
        x3_5 = self.__rb_5_3(x3_4)
        x3_6 = self.__rb_5_3(x3_5)
        x3_7 = self.__rb_5_3(x3_6)
        x3_8 = self.__rb_5_3(x3_7)

        x4_0 = self.__conv_5_4(x3_8)
        x4_1 = self.__rb_5_4(x4_0)
        x4_2 = self.__rb_5_4(x4_1)
        x4_3 = self.__rb_5_4(x4_2)
        x4_4 = self.__rb_5_4(x4_3)
